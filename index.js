...
const SubCategories_routes =require("../E-Commerce-Backend-Project/routes/subCat.routes"); //subCategories Routes
//address APi
...
app.use("/subcategories", SubCategories_routes ); //insert sub Categories

app.use("/statusActive", SubCategories_routes);//change sub cat active status

app.use("/changename", SubCategories_routes);//Sub cat name update

app.use("/findOneCat", SubCategories_routes);//Sub cat get detail by id

app.use("/deleteOne", SubCategories_routes);//sub cat delete by id
